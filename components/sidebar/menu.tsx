...
import { getMenuList } from "@/lib/constants"
  ...
  return (
    <ScrollArea className="[&>div>div[style]]:!block">
      <nav className="mt-8 size-full">
        <ul className="flex min-h-[calc(100vh-48px-36px-16px-32px)] flex-col items-start space-y-1 px-2 lg:min-h-[calc(100vh-32px-48px-32px)]">
              ...
              <div className="flex px-4 gap-2 items-center">
                ...
                <Link href="mailto:hello@workerai.co" target="_blank">
                  <Button variant="link" size={"useLink"}>
                    <h1 className="text-base font-semibold text-white">help@workerai.co</h1>
                  </Button>
                </Link>
              </div>
            </div>
