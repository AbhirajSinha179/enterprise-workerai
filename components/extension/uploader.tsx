...
>(({ className, index, children, ...props }, ref) => {
    ...
    return (
        <div
            ...
            {...props}
        >
            <div className="font-medium leading-none tracking-tight flex items-center gap-1.5 size-full">
                {children}
            </div>
            <button
                type="button"
            ...
            >
                ...
                <RemoveIcon className="size-4 hover:stroke-destructive duration-200 ease-in-out" />
            </button>
        </div>
    );
});
