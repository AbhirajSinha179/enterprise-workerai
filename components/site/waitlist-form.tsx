...
export const WaitlistForm = () => {
  ...
  return (
    <div className="mt-12 flex flex-row sm:flex-row max-w-3xl relative mx-auto items-center justify-center gap-4 sm:gap-2 px-4 sm:px-0">
      ...
      <div className="flex ">
        <Link href="https://www.calendly.com/rohit_workerai" passHref>
          <Button
            variant="secondary"
            className="inline-flex h-12 w-full sm:w-96 animate-shimmer items-center justify-center text-sm sm:text-md
                  rounded-md border bg-[length:200%_100%] px-4 sm:px-6 font-medium transition-colors focus:outline-none focus:ring-1 focus:ring-offset-1
