...
import { ClipboardCopyIcon, ClipboardSignatureIcon } from "lucide-react"
...
const SkeletonFour = () => {
  ...
  return (
    <motion.div
      ...
      animate="animate"
      whileHover="hover"
      className="dark:bg-dot-white/[0.2] bg-dot-black/[0.2] flex min-h-24 flex-1 flex-row space-x-2"
    >
      <motion.div
        variants={first}
...
const items = [
  ...
  },
  {
    ...
    className: "md:col-span-1",
    icon: <ClipboardSignatureIcon className="size-4 text-neutral-500" />,
  },
  {
