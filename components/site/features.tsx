    ...
    <section>
      <div className="font-geist relative mx-auto my-32 max-w-[1300px] rounded-none md:w-full md:border-[1.2px] xl:w-4/5 2xl:w-3/5">
        <svg
          ...
          className="lucide lucide-plus absolute left-[-17px] top-[-17px] h-8 w-8 text-white/30"
        >
        ...
        <div className="grid w-full grid-cols-1 md:grid-cols-3 md:grid-rows-5">
          <div className="flex flex-col items-center justify-center p-10  ">
            <div className="flex items-center justify-center rounded-full border-2 px-8 py-3 shadow dark:[border:0.5px_solid_rgba(255,255,255,.1)] dark:[box-shadow:0_-20px_80px_-20px_#8686f01f_inset]">
              <svg
                ...
                stroke-linecap="round"
                stroke-linejoin="round"
                className="lucide lucide-rabbit mx-auto h-7 w-7"
              >
          ...
          <div className="relative flex transform-gpu flex-col items-center  justify-center p-16 md:border-l-[1.2px]">
            <svg
              ...
              stroke-linecap="round"
              stroke-linejoin="round"
              className="lucide lucide-plus absolute bottom-[-17px] left-[-17px] h-8 w-8 text-white/30"
            >
              <path d="M5 12h14"></path>
              <path d="M12 5v14"></path>
            </svg>
          ...
          <div className="relative flex flex-col items-center  justify-center p-16 md:border-l-[0.2px]">
            ...
            <div className="flex items-center justify-center rounded-full border-2 px-8 py-3 shadow">
              <svg
                ...
                stroke-linecap="round"
                stroke-linejoin="round"
                className="lucide lucide-shield-check mx-auto h-7 w-7"
              >
          ...
          <div className="relative flex  transform-gpu flex-col items-center  justify-center p-10 md:border-l-[1.2px]  ">
            <svg
              ...
              stroke-linecap="round"
              stroke-linejoin="round"
              className="lucide lucide-plus absolute bottom-[-15px] right-[-15px] h-8 w-8 text-white/40"
            >
              <path d="M5 12h14"></path>
              <path d="M12 5v14"></path>
            </svg>
          ...
          <div className="flex flex-col items-center   justify-center p-16">
            ...
            <p className="mt-8 text-center text-sm text-muted-foreground">
              Arc is open source and always will be. You can check out the source code on our
              <a className="text-gray-50" href="https://github.com/arc-browser">
                Github
              </a>
              !
            </p>
          ...
          <div className="flex flex-col p-16  md:border-l-[1.2px]  md:border-t-2">
            ...
            <p className="mt-8 text-center text-sm text-muted-foreground">
              Arc is built by a community of passionate developers and designers. You can join us on our
