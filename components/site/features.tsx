        ...
        <div className="grid w-full grid-cols-1 md:grid-cols-3 md:grid-rows-4">
            ...
            <div className="left-0 top-0 flex h-full flex-col p-16 md:absolute md:px-10">
              <div className="">
                <div className="flex flex-col gap-4">
                  ...
                  <p className="mt-2 text-sm text-muted-foreground">
                    We are always looking for ways to make your experience better. Optimise your campaigns with our AI
          ...
          <div className="flex flex-col items-center justify-center p-16">
            ...
            <p className="mt-8 text-center text-sm text-muted-foreground">
              Worker AI is ready to be integrated with your existing tools. We are always looking for ways to make your
              experience better.
            </p>
          </div>
          ...
          <div className="flex flex-col p-16  md:border-l-[1.2px]  md:border-t-2">
            ...
            <p className="mt-8 text-center text-sm text-muted-foreground">
              Worker AI is built keeping you in mind. We are always here to help you with any queries or issues you may
              have.
            </p>
          </div>
        </div>
