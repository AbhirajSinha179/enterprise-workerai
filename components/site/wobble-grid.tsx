...
export function WobbleCardDemo() {
  return (
    <div className="mx-auto grid w-full max-w-7xl grid-cols-1 gap-4 lg:grid-cols-5">
      <WobbleCard
      ...
      >
        ...
        <Image
          ...
          className="rounded-2xl w-full h-full object-cover grayscale filter"
        />
      </WobbleCard>
      ...
      <WobbleCard containerClassName="col-span-1 lg:col-span-5 bg-blue-900 min-h-[500px] lg:min-h-[600px] xl:min-h-[300px]">
